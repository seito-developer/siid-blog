    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/80">
      <div className="container max-w-6xl mx-auto flex h-16 items-center justify-between gap-4 px-6">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          ...
          <HeaderCta className="inline-flex items-center rounded-full bg-siid-cta px-4 py-2 text-sm font-bold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg" />
        </div>

        {/* SP 右側: CTA(小) + ハンバーガー */}
        <div className="flex items-center gap-2 lg:hidden">
          <HeaderCta className="inline-flex items-center rounded-full bg-siid-cta px-3 py-1.5 text-xs font-bold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg" />
          <button
            type="button"
    ...
    <div className="lg:hidden" role="dialog" aria-modal="true" aria-label="メニュー">
      ...
      >
        ...
        <div className="border-t border-gray-200 p-4">
          <HeaderCta className="flex w-full items-center justify-center rounded-full bg-siid-cta px-4 py-3 text-sm font-bold text-white shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg" />
        </div>
      </div>
    </div>
  );
