  ...
  return (
    <aside className="not-prose rounded-xl border border-siid-main/30 bg-white p-5 sm:flex sm:items-center sm:justify-between sm:gap-6">
      ...
      <CtaLink
        ...
        ctaPosition="inline"
        articleSlug={slug}
        className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-full bg-siid-cta px-6 py-3 text-sm font-bold text-white shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg sm:mt-0 sm:w-auto sm:shrink-0"
      >
        SiiD無料カウンセリング
